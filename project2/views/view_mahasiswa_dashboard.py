...
class MahasiswaDashboard:
    ...
    def __init__(self, master=None, user=None, on_logout=None):
        ...
        T.center_window(self.master, 1200, 950)
    ...
    def _build_header(self, parent):
        ...
        tk.Label(
            header, text=f"Selamat Datang, {nama} 👋", font=(T.MONO, 11),
            fg=T.COLOR_ACCENT, bg=T.COLOR_BG, anchor="w",
        ).pack(fill="x", pady=(14, 2))
        tk.Label(
            header, text="Kelola data absensi mahasiswa dengan mudah",
    ...
    def _build_table(self, parent):
        ...
        T.make_title_bar(editor, "Data Absensi Mahasiswa")
        ...
        self.tree = ttk.Treeview(
            ...
            height=6, selectmode="browse", style=self._tree_style,
        )
        for col in columns:
    ...
    def _build_form(self, parent):
        ...
        # Padding bawah
        tk.Frame(form_frame, bg=T.COLOR_BG, height=20).grid(row=6, column=0)
